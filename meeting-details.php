...
$sql='SELECT `meetings_id`, `title`, `Content`, `Location`, `price`, `active`, `image`, `category_id`, `date`  FROM `meetings` WHERE `meetings_id`= :meetings_id';

$stmt = $conn->prepare($sql);
$stmt->bindParam(':meetings_id',$meetings_id);
$meetings_id=$id;
$stmt->execute();
            ...
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                  ...
                  <div class="price">
                    <span>$<?php echo "{$data['price']}" ?>.00</span>
                  </div>
                 <?php
                ...
                echo "
                  ...
                  ?>
                  <a href="meeting-details.php"><img src="./admin/<?php echo "{$data['image']}" ?>" alt=""></a>
                </div>
                <div class="down-content">
                  <a href="meeting-details.php"><h4><?php echo "{$data['title']}" ?></h4></a>
