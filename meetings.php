...
$sql="SELECT meetings.title,meetings.meetings_id,meetings.Content,meetings.price,meetings.Location,meetings.date,meetings.image,category.categoryName   
FROM category INNER JOIN meetings
ON meetings.category_id=category.category_id";
                ...
                <div class='col-lg-4 templatemo-item-col all soon'>
                  <div class='meeting-item'>
                    <div class='thumb'>
                      ...
                      <a href='meeting-details.php?id={$row['meetings_id']}'><img src='./admin/{$row['image']}'></a>
                    </div>
                    <div class='down-content'>
                      <div class='date'>
                        <h6>{$month} <span>{$day}</span></h6>
                      </div>
                      <a href='meeting-details.php?id={$row['meetings_id']}'><h4>{$row['title']}</h4></a>
