                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      foreach($data as $row){
                        ...
                        <tr>
                          ...
                          <td>{$row['title']}</td>
                          <td>{$row['active']}</td>
                          <td><a href='./editMeeting.php?id={$row['meetings_id']}'><img src='./images/edit.png' alt='Edit'></a></td>                      
                          <td> <a href='./deletemeeting.php?id={$row['meetings_id']}'><img src='./images/delete.png' alt='Delete'></a></td>
                        </tr>
                        ";
