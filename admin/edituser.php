...
if(isset($_POST['update'])){
    ...
    if(!empty($firstName) &&!empty($userName) &&!empty($email) &&!empty($password) &&!empty($act) ){

	$query = "UPDATE `users` SET `Username`='$userName',`email`='$email',`active`='$act',`password`='$password',`name`='$firstName'  WHERE user_id = $id";
