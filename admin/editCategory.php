...
if(isset($_POST['add'])){
	...
	$query = "UPDATE `category` SET `categoryName`='$category' WHERE  category_id = $id";
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="add-category" required="required" class="form-control " name="add_category">
											</div>
										</div>
